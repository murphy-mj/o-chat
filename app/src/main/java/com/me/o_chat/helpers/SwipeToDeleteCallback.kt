...
abstract class SwipeToDeleteCallback(context: Context) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {
    ...
    override fun getMovementFlags(recyclerViewF : RecyclerView, viewHolder: RecyclerView.ViewHolder): Int {
        /**
    ...
    override fun onChildDraw(
        c: Canvas, recyclerViewF : RecyclerView, viewHolder: RecyclerView.ViewHolder,
