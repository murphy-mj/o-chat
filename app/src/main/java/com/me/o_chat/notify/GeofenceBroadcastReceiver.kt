...
import com.me.o_chat.activities.MapUserSationSelected3Activity.Companion.ACTION_GEOFENCE_EVENT
import com.google.android.gms.location.Geofence
import com.google.android.gms.location.GeofencingEvent
import com.me.o_chat.R
import com.me.o_chat.activities.ImageCaptureActivity
import com.me.o_chat.activities.MapUserSationSelected3Activity
import com.me.o_chat.helpers.GeofencingConstants
import com.me.o_chat.helpers.errorMessage
import com.me.o_chat.helpers.sendGeofenceEnteredNotification
...
class GeofenceBroadcastReceiver :  BroadcastReceiver() {
    ...
    lateinit var foundIndex: String
    ...
    override fun onReceive(context: Context, intent: Intent) {
        if (intent.action == ACTION_GEOFENCE_EVENT) {
            ...
            if (geofencingEvent.geofenceTransition == Geofence.GEOFENCE_TRANSITION_ENTER) {
                ...
                // The fence id is the Station Id, so need to call an activity, with this data
                Log.d("Broadcast", "fence/staion id  ${fenceId}")
                foundIndex = fenceId
    ...
    private fun getMessageText(intent: Intent): CharSequence? {
        return androidx.core.app.RemoteInput.getResultsFromIntent(intent)?.getCharSequence(KEY_TEXT_REPLY)
    }
